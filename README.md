...
Each talk is a standalone Slidev project. To run locally:
...
Pushes to `main` trigger a GitHub Actions workflow that builds all talks and deploys to GitHub Pages automatically.
